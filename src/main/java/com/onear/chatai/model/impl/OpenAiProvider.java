...
public class OpenAiProvider extends AbstractHttpModelProvider {

    private final ObjectMapper mapper = new ObjectMapper();

    public OpenAiProvider(ModelInfo info) {
        super(info);
    }

    public OpenAiProvider(ModelInfo info, ApiKeyStore keyStore) {
        super(info, keyStore);
    }
